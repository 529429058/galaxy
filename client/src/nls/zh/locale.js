...
define({
    ...
    "Alignment file (maf, xmfa, stockholm)": "对齐文件（maf, xmfa, stockholm格式）",
    "Bin Size": "箱大小",
    "Links file": "链接文件",
    "Link End Behaviour": "链接端点行为",
    "Output Style": "输出样式",
    "Use number of links rather than sum of ends": "使用链接数量而非端点总和",
    "Calculate log10 of the values": "计算数值的以10为底的对数",
    "Normalize": "标准化",
    "Max Gap": "最大间隙",
    "Minimum Bundle Membership": "最小束成员数",
    "Minimum Bundle Extent": "最小束范围",
    "Minimum Bundle Size": "最小束大小",
    "Minimum Bundle Identity": "最小束一致性",
    "Reference Genome Source": "参考基因组来源",
    "Choose your Circos karyotype": "选择你的Circos核型",
    "Source Genome Build": "源基因组构建",
    "Source FASTA Sequence": "源FASTA序列",
    "Karyotype Configuration": "核型配置",
    "Sequence Lengths": "序列长度",
    "Limit/Filter and Order Chromosomes": "限制/过滤和排序染色体",
    "Reverse these Chromosomes": "反转这些染色体",
    "Chromosome units": "染色体单位",
    "Spacing Between Ideograms (in chromosome units)": "染色体图间间隔（以染色体单位计）",
    "Chromosome": "染色体",
    "Spacing between these two ideograms (in chromosome units)": "这两个染色体图之间的间隔（以染色体单位计）",
    "Radius": "半径",
    "Thickness": "厚度",
    "Angle Offset": "角度偏移",
    "Angle orientation": "角度方向",
    "Show Label": "显示标签",
    "Label Font Size": "标签字体大小",
    "Parallel": "平行",
    "Show Cytogenic Bands?": "显示细胞遗传带？",
    "Cytogenetic Bands": "细胞遗传带",
    "Convert bands from BED format to circos karyotype band format": "将带从BED格式转换为circos核型带格式",
    "Fill Bands": "填充带",
    "Band Transparency": "带透明度",
    "Band Stroke Thickness": "带描边厚度",
    "Plot Background": "绘图背景",
    "Image Radius": "图像半径",
    "Load additional colour profiles": "加载额外的颜色配置文件",
    "Outside Radius": "外半径",
    "Inside Radius": "内半径",
    "Plot Type": "图类型",
    "Histogram Data Source": "直方图数据源",
    "Fill underneath the histogram": "直方图下方填充",
    "Join non-abutting Bins": "连接非相邻箱子",
    "Heatmap Data Source": "热图数据源",
    "Color Scale": "颜色标度",
});
